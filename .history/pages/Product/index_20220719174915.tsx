          ...
          <div className={styles.displaytable1}>
            ...
            <table className={styles.Table_Width}>
              <tbody>
                ...
                <tr>
                  <td>Manufacturer	</td>
                  <td>‎Parude Technology (Shenzhen) Co. Ltd., Building A1, Red Box Creative Park, No. 3 Huancheng South Road, Bantian Street, Longgang District, Shenzhen City, China 518116.
</td>
                </tr>
                <tr>
                  <td>Technical Details</td>
