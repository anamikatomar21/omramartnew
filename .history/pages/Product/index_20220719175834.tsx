    ...
    <div>
      ...
      <div className={styles.container_width}>
        ...
        <div className={styles.company_info}>
          <h1 className={styles.span_box}>Company Information</h1>
          <p>
        ...
        <div className={styles.tableflex_box}>
          <div className={styles.displaytable1}>
            <h1 className={styles.span_box}>Technical Details</h1>
          ...
          <div className={styles.displaytable2}>
            <h1 className={styles.span_box}>Additional Information</h1>
            <table className={styles.Table_Width}>
            <tbody>
                <tr>
                  <td>Product Dimensions </td>
