...
const NewProductPage: NextPage = () => {
  ...
  const router=useRouter()
    ...
    const onChangeNumber=(e:React.EventHandler)=>{
      setuserMobileNumber(e.target.value)
    }
    const onSubmitMobileNumber=React.useCallback(()=>{

    },[])

    const callToConnect=`http://www.apiconnecto.com/UniProUser/Click-2-Call-API.aspx?UserId=${router.query.id}&pwd=pwd2020&AgentNum=xxxxxxxxxx&CustomerNum=xxxxxxxxxx&CampId=15823`
  return (
    <div>
      <TopHeader />
