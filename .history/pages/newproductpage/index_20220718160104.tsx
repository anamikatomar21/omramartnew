  ...
  const router=useRouter()
    ...
    const onChangeNumber=(e:any)=>{
      setuserMobileNumber(e.target.value)
        ...
        const callToConnect=`http://www.apiconnecto.com/UniProUser/Click-2-Call-API.aspx?UserId=${router.query.id}&pwd=pwd2020&AgentNum=xxxxxxxxxx&CustomerNum=${}&CampId=15823`
