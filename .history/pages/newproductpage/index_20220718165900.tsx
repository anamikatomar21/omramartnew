...
const NewProductPage: NextPage = () => {
  ...
  const currentProduct = data?.data.find((d:any) => d?._id ===router?.query?.id);
  // const isSame=data?.data.find((w)=>w._id==router?.query?.id)
  const [ProductImage, setProductImage] = useState(currentProduct?.product_image1[0]|| '/')
            ...
            <div className={styles.flex_box1}>
              ...
              <div className={styles.smallimage}>
                ...
                <Image
                  ...
                  onClick={()=>onImageSelect(currentProduct?.product_image1[0])}
                />
                ...
                <Image
                  ...
                  alt="productr image"
                  className={styles.productimagesrc1}
                  onClick={()=>onImageSelect(currentProduct?.product_image2[0])}
                />
                ...
                <Image
                  ...
                  alt="productr image"
                  className={styles.productimagesrc1}
                  onClick={()=>onImageSelect(currentProduct?.product_image3[0])}
                />
                ...
                <Image
                  ...
                  alt="productr image"
                  className={styles.productimagesrc1}
                  onClick={()=>onImageSelect(currentProduct?.product_image4[0])}
                />
