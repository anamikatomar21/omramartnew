...
const NewProductPage: NextPage = () => {
  ...
  const router=useRouter()
    ...
    const callToConnect=`http://www.apiconnecto.com/UniProUser/Click-2-Call-API.aspx?UserId=DIGIVOICE&pwd=pwd2020&AgentNum=xxxxxxxxxx&CustomerNum=xxxxxxxxxx&CampId=15823`
  return (
    <div>
      <TopHeader />
