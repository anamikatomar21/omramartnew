        ...
        <div>
          <div className={styles.flex_box}>
                  ...
                  <form className={styles.FormWidth}>
                    <ul>
                      ...
                      <li>
                        ...
                        type="text" className={styles.NumberInput} />
                      </li>
            ...
            <div className={styles.flex_box2}>
              <h1>
                Business Name:{" "}
                <span className={styles.span_box}>{currentProduct?.product_name}</span>{" "}
              </h1>
...
const dummy={
  ...
  "Merchant_Address": "C-9 First Floor, Near- SDMC Primary School Rampura, Harinagar,New Delhi-110064",
  "product_name": "105x300 meters,WAX thermal transfer ribbon for printer TSC, ZEBRA, CITZEN, THOSIBA, SATO etc.",
