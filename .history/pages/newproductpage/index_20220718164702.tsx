          ...
          <div className={styles.flex_box}>
            <div className={styles.flex_box1}>
              ...
              <div className={styles.smallimage}>
                ...
                <Image
                  src={currentProduct?.export const useSubCategory = () => useMutation(
                    ({
                      category_Id,
                      category_name,
                ...
                />
                <Image
                  src={currentProduct?.product_image2 || '/'}
                  height={120}
                  width={120}
                  alt="productr image"
                  className={styles.productimagesrc1}
                />
                <Image
                  src={currentProduct?.product_image3 || '/'}
                  height={120}
                  width={120}
                  alt="productr image"
                  className={styles.productimagesrc1}
                />
                <Image
                  src={currentProduct?.product_image4 || '/'}
                  height={120}
                  width={120}
                  alt="productr image"
                  className={styles.productimagesrc1}
