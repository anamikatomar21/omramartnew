...
<div className={styles.popup}>
    ...
    <div className={styles.content1}>
        ...
        <p className={styles.Font}>Tell us about your requirement
        ...
        <form className={styles.FormWidth}>
            ...
            <ul>
                ...
                <li>
                    ...
                    <textarea className={styles.TextareaSection}
                ...
                <li className={styles.checkboxstyle}>
                    ...
                    <div>
                        ...
                        <span className={styles.SpanClass}>Send this inquiry to other Suppliers of similar products(?)</span>
                ...
                <li className={styles.ModalSection}>
                    ...
                    <div>
                        ...
                        <input type="email" className={styles.Input} placeholder="EMAIL ID " /></div>

                    <div>  <input type="tel" className={styles.Input} placeholder="Phone number " /></div>
                ...
                <li><button type='submit' className='submit_button_box'><a href="#">SEND INQUIRY</a></button></li>
            ...
            <div className='buttonmodel'>
                ...
                <a href="whatsapp://send?text=Hello World!&phone=+917017342584" className='whatsapp-icon'>
                    ...
                    <img src="/omratrade/whatsapp.png" alt="" className='whatsapp-icon' /></a>

                <a href="whatsapp://send?text=Hello World!&phone=+917017342584" className='whatsapp-icon'>



                    <img src="/omratrade/email.png" alt="" className='whatsapp-icon' /></a> */}
