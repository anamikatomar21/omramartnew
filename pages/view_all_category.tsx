...
<section className="catlogsection">
  <div className="container">
    ...
    <div className={` ${styles.img_box} col-md-3`}>Laundery Machine & Equipments</div>
        <div className={` ${styles.img_box1} col-md-3`}>Dryclean Machine & Equipment</div>
        <div className={` ${styles.img_box2} col-md-3`}>Laundry Bags</div>
        <div className={` ${styles.img_box3} col-md-3`}>Chemical & Detergent</div>
        <div className={` ${styles.img_box4} col-md-3`}>QR code printer</div>
      ...
      <div className={styles.Flex_Section}>
        ...
        <div className={styles.img_box7}>sss</div>
      </div> */}
    </div>
