...
<div className='rightsidebar'><MerchantSidebar /></div>
            ...
            <AdminLayout>
                <div>
                    <h1 className={styles.heading_box}> Welcome to your SuperAdmin Dashboard</h1>
                </div>
                
                <div className={styles.flex_box}>
                    <div className={styles.flex_box1}><h1>Total Merchant</h1> </div>
                    <div className={styles.flex_box2}><h1> All  Approved Listing</h1> </div>
                    <div className={styles.flex_box3}><h1>Pending Listing</h1>  </div>
                </div>
