      ...
      <ul className='box345'>
            <li>
              <div className='imagepre'>
                <div className='row'>
                  <div className='col-md-6'><Image src="https://m.media-amazon.com/images/I/61+ilDgVVwS._UL1500_.jpg" alt="facemask" className='facemask' /></div>
                  <div className='col-md-6'><Image src="https://m.media-amazon.com/images/I/61+ilDgVVwS._UL1500_.jpg" alt="facemask" className='facemask' /></div>
                </div>
              </div>
            </li>
            ...
            <li><label htmlFor="" className="omra-lael">
              ...
              <input type="text" name="" id="" placeholder="Name " /></li>
            <li>
              <input type="tel" name="" id="" placeholder="Phone no. " /></li>
            <li>
              <input type="text" name="" id="" placeholder="Address " /></li>
            ...
            <li className='qtyproduct'>
              <div className='row'>
                <div className='col-md-6'>
                  ...
                  <input type="number" name="" id="" className="box-input-section" />
                </div>
                <div className='col-md-6'>
                  <label htmlFor="" className="omra-lael">
                    Qty
            ...
            <li> <label htmlFor="" className="omra-lael">
              ...
              <input type="text" name="" id="" placeholder="Length :l x b x h " className="box-input-textarea2" />
            </li>
            <li> <label htmlFor="" className="omra-lael">
              ...
              <input type="text" name="" id="" placeholder="" className="box-input-textarea" />
            </li>
            <li> <label htmlFor="" className="omra-lael">
